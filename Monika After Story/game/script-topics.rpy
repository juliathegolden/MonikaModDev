            ...
            menu: 
                "No, not at all.":
                    ...
                    if lowerpen = player.lower():
                        m 3d "Oh, so you're using your pen name with me?" 
                        m "I'd like to think that we are on a first name basis with each other. We are dating, after all."
                ...
                "I've told you before.":
                    m 3n "Oh! Right! It's [penname], right?"
                    m "Sorry. I had a moment there. But at least you know you can tell me if you change it."                    
        "No":
            m 1j "All right!"
